...
public class EditProfile extends AppCompatActivity {
    ...
    TextView updatepassword,updatephone,updatename,updatepicture;
    ...
    void init(){
        updatepicture  = findViewById(R.id.updateprofilepic);
        updatename   = findViewById(R.id.updateprofilename);
        set = findViewById(R.id.profilepic);
         progressDialog = new ProgressDialog(this);
        progressDialog.setCanceledOnTouchOutside(false);
        updatepassword  = findViewById(R.id.updateprofilepassword);
        updatephone = findViewById(R.id.updateprofilephone );
